...
import com.soft.common.CurrencyUtils;
import com.soft.common.IMOOCJSONResult;
import com.imooc.utils.RedisOperator;
import com.soft.enums.PayMethod;
...
public class PaymentController {
	...
	public IMOOCJSONResult createMerchantOrder(@RequestBody MerchantOrdersVO merchantOrdersVO, HttpServletRequest request, HttpServletResponse response) throws Exception {

		String merchantOrderId = merchantOrdersVO.getOrderId();             	// 订单id
		String merchantUserId = merchantOrdersVO.getUserId();     		// 用户id
		Integer amount = merchantOrdersVO.getAmount();    // 实际支付订单金额
		Integer payMethod = merchantOrdersVO.getPayMethod();          	// 支付方式
		String returnUrl = merchantOrdersVO.getReturnUrl();           	// 支付成功后的回调地址（学生自定义）
...
//	@GetMapping(value="/getWXPayQRCode")
	...
	public IMOOCJSONResult getWXPayQRCode(@RequestParam("merchantOrderId") String merchantOrderId, @RequestParam("merchantUserId") String merchantUserId) throws Exception{
